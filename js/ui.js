...
const UI = {
    ...
    switchTab(tab) {
        ...
        // Exit SIM mode when leaving SIM tab
        ...
        // Hide HTML overlays in OSC+INFO — canvas panel covers entire area
        const oL = document.getElementById('overlayLeft');
        const oR = document.getElementById('overlayRight');
        if (oL) oL.style.display = infoTab ? 'none' : '';
        if (oR) oR.style.display = infoTab ? 'none' : '';
